...
activities = {
    ...
    "Basketball Team": {
        "description": "Team-based basketball training and competition",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu", "maria@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Practice skills and play friendly soccer matches",
    ...
    "Science Olympiad": {
        "description": "Prepare for science team competitions and experiments",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 14,
